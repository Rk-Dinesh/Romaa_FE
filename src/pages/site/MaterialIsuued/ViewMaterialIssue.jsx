                ...
                <div className="flex gap-2">
                  <div className="relative">
                    <select
                      ...
                      onChange={(e) => { setDateFilterType(e.target.value); setDateValue(""); }}
                      className="h-full pl-3 pr-8 py-2 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-sm font-medium text-gray-600 dark:text-gray-300 focus:ring-2 focus:ring-orange-500 outline-none appearance-none cursor-pointer"
                    >

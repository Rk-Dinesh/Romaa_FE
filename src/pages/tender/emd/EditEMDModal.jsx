          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mx-5 text-xs flex lg:justify-end md:justify-center justify-center gap-2 mb-4">
              <button
                ...
                onClick={onclose}
                disabled={isPending}
                className="cursor-pointer border dark:border-white border-darkest-blue dark:text-white text-darkest-blue px-6 py-2 rounded hover:bg-gray-50 transition-colors dark:hover:bg-gray-700"
              >
                Cancel
              </button>
              <button
                type="submit"
                disabled={isPending}
                className="cursor-pointer px-6 bg-darkest-blue text-white rounded hover:bg-blue-900 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
              >

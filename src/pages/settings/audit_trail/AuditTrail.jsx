...
const AuditDrawer = ({ row, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-40 flex justify-end" role="dialog" aria-modal="true" aria-label="Audit row details">
      ...
      <aside className="relative w-full max-w-xl h-full bg-white dark:bg-layout-dark shadow-2xl flex flex-col border-l border-gray-200 dark:border-gray-800">
        ...
        <div className="px-5 py-2.5 bg-gray-50 dark:bg-gray-900/40 border-b border-gray-100 dark:border-gray-800 grid grid-cols-2 gap-2 text-[10px]">
          <div>
  ...
  return (
    <div className="flex flex-col h-full font-roboto-flex bg-slate-50 dark:bg-overall_bg-dark">
      ...
      <div className="px-6 pb-3">
        <div className="bg-white dark:bg-layout-dark border border-gray-200 dark:border-gray-800 rounded-xl px-4 py-3">

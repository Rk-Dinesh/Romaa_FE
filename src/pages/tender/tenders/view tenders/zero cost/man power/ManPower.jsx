    ...
    <div className="font-roboto-flex flex flex-col gap-4 h-full p-2">
       ...
       <div className="flex gap-2">
              <button 
                ...
                className={`text-xs px-3 py-1.5 rounded border ${activeTab === 'nmr' ? 'bg-blue-50 border-blue-200 text-blue-700' : 'bg-gray-50 text-gray-600'}`}
              >
                 NMR
              </button>
              <button 
                 onClick={() => !isEditing && setActiveTab("contractor")}
                 className={`text-xs px-3 py-1.5 rounded border ${activeTab === 'contractor' ? 'bg-orange-50 border-orange-200 text-orange-700' : 'bg-gray-50 text-gray-600'}`}
              >
                 Contractor
              </button>
           </div>
      ...
      <div className="bg-white dark:bg-layout-dark rounded-md shadow border border-gray-200 dark:border-border-dark-grey overflow-hidden">
        ...
        <div className="w-full flex items-center justify-between px-4 py-2 bg-gray-50 dark:bg-overall_bg-dark border-b border-gray-200 dark:border-border-dark-grey">
           <span className="text-sm font-semibold flex items-center gap-2 py-1.5">
              {/* {activeTab === 'nmr' ? <FaTruckMonster className="text-gray-400"/> : <FaGasPump className="text-gray-400"/>} */}
              {activeTab === 'nmr' ? ' NMR ' : ' Contractor '}
           </span>
